...
const clerkAppearance = {
  ...
  elements: {
    ...
    formButtonPrimary: "bg-primary text-primary-foreground hover:bg-primary/90 transition-colors shadow-[0_0_15px_rgba(147,51,234,0.3)]",
    formFieldInput: "bg-input border-border text-foreground focus:ring-primary placeholder:text-muted-foreground",
    footerAction: "",
  ...
  return (
    <ClerkProvider
      ...
      localization={{
        signIn: {
          start: {
            title: "Welcome to AnimeMorph AI",
            subtitle: "Enter the studio",
          },
        },
        signUp: {
          start: {
